...
/*
HTTP servers are useful for demonstrating the usage of context.Context for controlling cancellation. A Context carries deadlines,
...
func main() {
	...
	fmt.Println("server: listening on port :8090. http://localhost:8090/hello")
...
func hello(w http.ResponseWriter, req *http.Request) {
	...
	// Wait for a few seconds before sending a reply to the client. This could simulate some work the server is doing. While working,
